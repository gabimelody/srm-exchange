...
public class SearchCoinByIdUseCaseTest {
    ...
    @InjectMocks
    private SearchCoinByIdUseCase searchCoinByIdUseCase;

    @Test
    @DisplayName("Execute should search coin by id")
    void execute_shouldSearchById() {
        ...
        // Then
        assertEquals(outbound, searchCoinByIdUseCase.execute(id));
    }
