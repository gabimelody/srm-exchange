...
public class UpdateProductUseCaseTest {
    ...
    void execute_shouldThrowKingdomNotFoundException() {
        ...
        // Then
        assertThrows(KingdomNotFoundException.class, () -> updateProductUseCase.execute(id, inbound));
    }
    ...
    void execute_shouldThrowCoinNotFoundException() {
        ...
        // Then
        assertThrows(CoinNotFoundException.class, () -> updateProductUseCase.execute(id, inbound));
    }
